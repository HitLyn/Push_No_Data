...
DATA_PATH = '/home/lyn/HitLyn/Push/new_data'
...
class Model():
    def __init__(self, object_state_dim, robot_action_dim, env_time_step, rnn_units, batch_size, time_steps):
        ...
        self.object_data = np.load(os.path.join(DATA_PATH, 'object_data_60.npy'))
        self.robot_data = np.load(os.path.join(DATA_PATH, 'robot_data_60.npy'))
        ...
        self.train_object_data, self.test_object_data, self.train_robot_data, self.test_robot_data = self.train_object_data.reshape(-1, 13), self.test_object_data.reshape(-1, 13), self.train_robot_data.reshape(-1, 6), self.test_robot_data.reshape(-1, 6)
    ...
    def train(self, data_set, test_data_set):
        ...
        for epoch in range(self.epochs):
            ...
            template = 'Epoch {}, Loss: {}, Error: {}, Test Loss: {}, Test Error: {}'
