...
SAVE_PATH = '/home/lyn/HitLyn/Push/sampled_model_randomized'
...
class Model():
    def __init__(self, object_state_dim, robot_action_dim, env_time_step, rnn_units, batch_size, time_steps, load_data = False, build = True):
        ...
        self.model = tf.keras.Sequential([
            ...
            tf.keras.layers.LSTM(rnn_units, return_sequences = True, recurrent_initializer='glorot_uniform', recurrent_regularizer=tf.keras.regularizers.l2(0.05), dropout = 0.6),
...
def main():
    model = Model(3, 2, 42, 128, 64, 3, load_data = True)
