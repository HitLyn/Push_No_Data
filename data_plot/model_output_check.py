...
def main():
    ...
    test_robot_data_raw = np.load(os.path.join(DATA_PATH, 'robot_pure_test.npy')).reshape(-1, 6)
    test_object_data_raw = np.load(os.path.join(DATA_PATH, 'object_pure_test.npy')).reshape(-1, 13)
